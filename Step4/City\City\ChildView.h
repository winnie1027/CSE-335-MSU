...
private:
    ...
    bool mReport = false;           ///< Are we displaying the report?
...
public:
    ...
    afx_msg void OnViewCityreport();
    afx_msg void OnUpdateViewCityreport(CCmdUI* pCmdUI);
    afx_msg void OnBusinessesRocketpad();
