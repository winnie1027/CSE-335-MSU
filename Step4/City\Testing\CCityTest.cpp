...
namespace Testing
{
	...
	public:
        ...
        TEST_METHOD(TestCCityVisitor)
        {
            ...
            // Empty cities
            city.Accept(&visitor);
            Assert::AreEqual(0, visitor.mNumRoads,
                L"Visitor number of roads");
            Assert::AreEqual(0, visitor.mNumBuildings,
                L"Visitor number of buildings");
            Assert::AreEqual(0, visitor.mNumLandscapes,
                L"Visitor number of landscapes");
            Assert::AreEqual(0, visitor.mNumCoalmines,
