...
public:
    ...
    */
    ...
    void SetMachineOne(std::shared_ptr<CMachineDrawable> machineOne) { mMachineOne = machineOne; }
    std::shared_ptr<CMachineDrawable> GetMachineOne() { return mMachineOne; }

    void SetMachineTwo(std::shared_ptr<CMachineDrawable> machineTwo) { mMachineTwo = machineTwo; }
    /**
    * Get machine two.
    * \return Machine two
    */
    std::shared_ptr<CMachineDrawable> GetMachineTwo() { return mMachineTwo; }
...
private:
    ...
    /// Machine one drawable
    std::shared_ptr<CMachineDrawable> mMachineOne;

    /// Machine tne drawable
    std::shared_ptr<CMachineDrawable> mMachineTwo;
