 ...
 * Remove frame.
 */
void CAnimChannel::RemoveFrame()
{
    if (mKeyframe1 >= 0)
    {
        if (mTimeline->GetCurrentFrame() == mKeyframes[mKeyframe1]->GetFrame())
        {
    ...
    else if (mKeyframe1 < 0)       // at first keyframe
    {
        return;
    }
}
 ...
 * Use as 1
 */
void CAnimChannel::Keyframe::UseAs1()
{
 ...
 * Use as 2
 */
void CAnimChannel::Keyframe::UseAs2()
{
 ...
 * Use only
 */
void CAnimChannel::Keyframe::UseOnly()
{
